      ...
      <div className="grid md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          {result && status === AnalysisStatus.COMPLETED && (
            <div className={`p-8 rounded-2xl border-2 transition-all-custom fade-in ${result.tumorClass.toUpperCase() === 'MALIGNANT'
              ...
              <div className="flex items-start justify-between mb-6">
                ...
                <div className="text-right">
                  <span className="text-3xl font-black text-slate-900">{result.confidence.toFixed(3)}%</span>
